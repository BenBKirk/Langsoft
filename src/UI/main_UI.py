...
class LeftPane(QWidget):
    def __init__(self):
        ...
        self.grammar_vocab_toggle = QAction("toggle_v",self)
        self.grammar_vocab_toggle.setToolTip("Toggle grammar and vocabulary highlights")
        ...
        self.toolbar.addWidget(QLabel(" ")) 
        self.toolbar.addAction(self.grammar_vocab_toggle)
        self.toolbar.addWidget(QLabel(" ")) 
