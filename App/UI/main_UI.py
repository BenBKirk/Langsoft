...
class TopRightPane(QWidget):
    def __init__(self):
        ...
        self.confidence_btn3 = QPushButton("3.Known")
        # self.confidence_btn4 = QPushButton("4.Well-Known")
        self.confidence_btn1.setStyleSheet(f"background-color : rgb(255,0,0)")
        self.confidence_btn2.setStyleSheet(f"background-color : rgb(255,255,0)")
        self.confidence_btn3.setStyleSheet(f"background-color : rgb(0,255,0)")
        # self.confidence_btn4.setStyleSheet(f"background-color : rgb(255,255,255)")
        color_btn_layout = QHBoxLayout()
        color_btn_layout.addWidget(self.confidence_btn1)    
        color_btn_layout.addWidget(self.confidence_btn2)
        color_btn_layout.addWidget(self.confidence_btn3)
        ...
        split_top_right_flash_side.addWidget(widget_for_btn_layout)#
        ...
        split_top_right_vocab_side.setSizes([500,500])
        ...
        self.add_sel_to_vocab_tracker_btn = QLabel("Track word/selection")
        self.add_sel_to_vocab_tracker_btn.setFixedHeight(10)
        ...
        # split_up_right_vocab_side.addWidget(widget_for_btn_layout)
