...
class MainUIWidget(QWidget):
    ...
    def __init__(self):
        ...
        self.flash_audio_label = QLabel()
        self.flash_audio_label.setText("")
        self.flash_audio_btn = QPushButton("add audio snippet")
        self.flash_audio_btn.setFixedWidth(150)
        audio_layout = QHBoxLayout()
        audio_layout.addWidget(self.flash_audio_btn)
        audio_layout.addWidget(self.flash_audio_label)
        widget_for_flash_audio = QWidget()
        widget_for_flash_audio.setLayout(audio_layout)

        # self.flash_start_time = QSpinBox()
        # self.flash_start_time.setFixedWidth(100)
        # self.flash_start_time.setMaximum(1000000000)
        # self.flash_end_time = QSpinBox()
        # self.flash_end_time.setFixedWidth(100)
        # self.flash_end_time.setMaximum(1000000000)
        # self.play_audio_section = QPushButton(text="Play")
        # audio_layout = QHBoxLayout()
        # audio_layout.addWidget(self.flash_audio_label)
        # audio_layout.addWidget(self.flash_start_time)
        # audio_layout.addWidget(QLabel("-"))
        # audio_layout.addWidget(self.flash_end_time)
        # audio_layout.addWidget(self.play_audio_section)
        # audio_layout.setAlignment(Qt.AlignLeft)
        # widget_for__flash_audio_layout = QWidget()
        # widget_for__flash_audio_layout.setLayout(audio_layout)
        ...
        splitter3.addWidget(widget_for_flash_audio)
        # splitter3.addWidget(self.flash_audio_label)
        # splitter3.addWidget(self.flash_audio_btn)
